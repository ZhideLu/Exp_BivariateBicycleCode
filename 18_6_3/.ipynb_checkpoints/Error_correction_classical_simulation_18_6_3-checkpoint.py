...
print(f'Logical error over {num_cycles+1} cycles (six logical qubits):', 1-X_no_correction_good_trials/num_trials_x)
...
print(f'Logical error over {num_cycles+1} cycles (six logical qubits):', 1-X_good_trials/num_trials_x)
