...
from BB_code_18_4_4 import ell, m, n, n2, A, B, AT, BT, num_end 
from BB_code_18_4_4 import distance_test, rank2, get_connection_Tanner, get_layout
from BB_code_18_4_4 import get_SM_circuit_parallel, get_SM_circuit_separate
from BB_code_18_4_4 import simulate_circuit_Lx, simulate_circuit_Lz
from BB_code_18_4_4 import get_Set_noisy_circuits_logical_X, get_Set_noisy_circuits_logical_Z
from BB_code_18_4_4 import decoding_X_matrix, decoding_Z_matrix
from BB_code_18_4_4 import simulate_syndrome_Lx, simulate_syndrome_Lz 
from BB_code_18_4_4 import generate_noisy_circuit
from BB_code_18_4_4 import error_decoding
...
with open(f'Decoder/Set_decoder_para_18_4_4_scaling{scaling_factor}.pkl', 'wb') as f:
