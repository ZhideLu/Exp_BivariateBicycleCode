...
# with_heating:   "yes" for with leakage heating, "no" for no leakage heating 
...
if budget_component == "CZ" :
    error_rate_cz_com = 0
    for i in range(num_qubits):
        dict_channel_tq[i] = generate_channel_t(t_gate = 0.105, with_coherence="no", with_heating="yes", T1 =  set_T1[i], Tphi = set_Tphi[i] )
...
if budget_component == "leakage" :
    channel_cz = generate_channel_t(0, with_coherence="no", with_heating="no", T1 = 10**10, Tphi = 10**10) 

    for i in range(num_qubits):
        dict_channel_sq[i] = generate_channel_t(t_gate = 0.03, with_coherence="yes", with_heating="no", T1 = set_T1[i], Tphi = set_Tphi[i] )
        dict_channel_tq[i] = generate_channel_t(t_gate = 0.105, with_coherence="yes", with_heating="no",T1 =  set_T1[i], Tphi = set_Tphi[i] )
        dict_channel_DD[i] = generate_channel_t(t_gate = 0.92, with_coherence="yes", with_heating="no", T1 = set_T1[i], Tphi = set_Tphi[i] )
        dict_channel_idle[i] = generate_channel_t(t_gate = 0.105, with_coherence="yes", with_heating="no", T1 = set_T1[i], Tphi = set_Tphi[i] )

if budget_component == "SQ" :
    error_rate_sq_com = 0
    for i in range(num_qubits):
        dict_channel_sq[i] = generate_channel_t(t_gate = 0.03, with_coherence="no", with_heating="yes", T1 = set_T1[i], Tphi = set_Tphi[i] )

if budget_component == "DD" :
    for i in range(num_qubits):
        dict_channel_DD[i] = generate_channel_t(t_gate = 0.92, with_coherence="no", with_heating="yes", T1 = set_T1[i], Tphi = set_Tphi[i] )

if budget_component == "idle" :
    error_rate_idle_com = 0
    for i in range(num_qubits):
        dict_channel_idle[i] = generate_channel_t(t_gate = 0.105, with_coherence="no", with_heating="yes", T1 = set_T1[i], Tphi = set_Tphi[i] )
