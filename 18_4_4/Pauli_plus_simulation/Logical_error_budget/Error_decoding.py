...
if basis_type == "Z":
    ...
    print("budget_component:", budget_component)
    ...
    sname = './Numerical_results/' + 'Logical_Z_' + 'cycle_' + str(num_cycles) + 'budget_' + budget_component + '.mat'
    savemat(sname, 
...
if basis_type == "X":
    ...
    sname = './Numerical_results/' + 'Logical_X_' + 'cycle_' + str(num_cycles) + 'budget_' + budget_component + '.mat'
    savemat(sname, 
            {'num_cycles': num_cycles, 
             'budget_component': budget_component, 
