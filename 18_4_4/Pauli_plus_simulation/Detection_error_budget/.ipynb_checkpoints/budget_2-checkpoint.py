...
channel_tq = generate_channel_t(0)      # 105ns two-qubit gate
channel_DD = generate_channel_t(0)       # 920ns DD
channel_idle = generate_channel_t(0)    # 105ns idle
