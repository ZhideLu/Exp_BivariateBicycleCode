...
error_rate_excess = float(sys.argv[3]) ;

num_cycles = 6 ;
num_sim_samples = 80000 ;
...
if basis_type == "Z":
    ...
    fname = './Numerical_data/' + 'Logical_Z_' + 'budget_' + budget_component + '_excess_' + str(error_rate_excess)  + '.mat'
    savemat(fname, 
...
if basis_type == "X":
    ...
    fname = './Numerical_data/' + 'Logical_X_' + 'budget_' + budget_component + '_excess_' + str(error_rate_excess) + '.mat'
    savemat(fname, 
            { 'num_samples': num_sim_samples,
             'retain_data_fraction':retain_data_fraction,
             'retained_num_samples': retained_num_samples,
